    ...
    while run:
        ...
        for i in range(len(snake_body) - 1): 
            ...
            if head[0] == part[0] and head[1] == part[1]:
                run = False
                print("PERDISTE MMGVO")

        play_surface.fill((255,255,255))

        for pos in snake_body:
            pygame.draw.rect(play_surface,(0,0,0), pygame.Rect(pos[0], pos[1], 10, 10))
        
        pygame.draw.rect(play_surface,(0,0,0), pygame.Rect(food_pos[0], food_pos[1], 10, 10))
